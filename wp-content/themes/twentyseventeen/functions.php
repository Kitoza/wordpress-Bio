...
function create_post_type(){
	register_post_type('maladie',
		array(
			'labels' => array(
				'name' => __('Maladies'),
				'singular_name' =>__('Maladie')
			),
			'public' => true
		)
		);
	
	register_taxonomy('couleur','maladie',array('hierarchical' => true,'label'=> 'Couleur','query_var' => true,'rewrite' => true));
}
...
function wpc_cpt_in_home($query) {
	if (! is_admin() && $query->is_main_query()) {
	  if ($query->is_home) {
		$query->set('post_type', array('maladie'));
	  }
	}
  }
